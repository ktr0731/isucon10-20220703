...
func searchEstates(c echo.Context) error {
	...
	if c.QueryParam("doorHeightRangeId") != "" {
		...
		n, err := strconv.Atoi(c.QueryParam("doorHeightRangeId"))
		if err != nil {
			return c.NoContent(http.StatusBadRequest)
		}

		conditions = append(conditions, "door_height_class = ?")
	...
	if c.QueryParam("doorWidthRangeId") != "" {
		...
		n, err := strconv.Atoi(c.QueryParam("doorWidthRangeId"))
		if err != nil {
			return c.NoContent(http.StatusBadRequest)
		}

		conditions = append(conditions, "door_width_class = ?")
		params = append(params, n)
	}
	...
	if c.QueryParam("rentRangeId") != "" {
		...
		n, err := strconv.Atoi(c.QueryParam("rentRangeId"))
		if err != nil {
			return c.NoContent(http.StatusBadRequest)
		}

		conditions = append(conditions, "rent_class = ?")
		params = append(params, n)
	}
